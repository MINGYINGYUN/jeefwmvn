		...
		<div class="well well-sm">
			<shiro:hasPermission name="${ROLE_KEY}:information:add">
				<a id="addInformationButton" role="button"
					class="btn btn-info btn-sm" data-toggle="modal"> 添加记录 </a>
			</shiro:hasPermission>
			...
			<shiro:hasPermission name="${ROLE_KEY}:information:edit">
				<a id="editInformationButton" role="button"
					class="btn btn-purple btn-sm" data-toggle="modal"> 编辑记录 </a>
			</shiro:hasPermission>
			<shiro:lacksPermission name="${ROLE_KEY}:information:edit">
				<a id="editInformationButton" role="button" disabled="disabled"
					class="btn btn-purple btn-sm" data-toggle="modal"> 编辑记录 </a>
			</shiro:lacksPermission>
			<form id="informationHibernateSearchForm"
				class="nav-search form-search">
				<span class="input-icon" style="position: relative; top: -30px;">
					<input type="text" placeholder="全文检索 ..." class="nav-search-input"
					id="search-input" autocomplete="off" /> <i
		...
		<form id="informationForm">
			<div class="modal-content">
				...
				<div class="modal-body"
					...
					<div class="blue clearfix">
						<label for="author">作者：</label> <input type="text" id="author"
							class="width-100" />
					</div>
