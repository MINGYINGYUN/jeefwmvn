...
<div class="page-header">
	<h1>
		邮件收发 <small> <i class="ace-icon fa fa-angle-double-right"></i>
...
<div class="row">
	<div class="col-xs-12">
								...
								<div id="id-message-list-navbar" class="message-navbar clearfix">
									<div class="message-bar">
										<div class="message-infobar" id="id-message-infobar">
											<span class="blue bigger-150">收件箱</span> <span
												class="grey bigger-110">(2封未读邮件)</span>
										</div>
										...
										<div class="message-toolbar hide">
											<div class="inline position-relative align-left">
												...
												<ul
													...
													<li><a href="#"> <i
															class="ace-icon fa fa-mail-reply blue"></i>&nbsp; 回复
													</a></li>

													<li><a href="#"> <i
															class="ace-icon fa fa-mail-forward green"></i>&nbsp; 转发
													</a></li>

													<li><a href="#"> <i
															class="ace-icon fa fa-folder-open orange"></i>&nbsp; 存档
													</a></li>

													<li class="divider"></li>

													<li><a href="#"> <i
															class="ace-icon fa fa-eye blue"></i>&nbsp; 标记为已读邮件
													</a></li>

													<li><a href="#"> <i
															class="ace-icon fa fa-eye-slash green"></i>&nbsp; 标记为未读邮件
													</a></li>

													<li><a href="#"> <i
															class="ace-icon fa fa-flag-o red"></i>&nbsp; 标记星标
													</a></li>
										...
										<div class="messagebar-item-left">
											...
											<div class="inline position-relative">
												...
												<ul class="dropdown-menu dropdown-lighter dropdown-100">
													<li><a id="id-select-message-all" href="#">全选</a></li>

													<li><a id="id-select-message-none" href="#">反选</a></li>

													<li class="divider"></li>

													<li><a id="id-select-message-unread" href="#">未读</a></li>

													<li><a id="id-select-message-read" href="#">已读</a></li>
												</ul>
											</div>
										</div>
									...
									<div>
										...
										<div class="messagebar-item-right">
											<span class="inline btn-send-message">
												<button id="sendEmailButton" type="button"
									...
									<div class="message-list" id="message-list">
										...
										<div class="message-item message-unread">
											<label class="inline"> <input type="checkbox"
												...
												class="sender" title="JavaEEFramework">JavaEEFramework</span>
											<span class="time">1:33 下午</span> <span class="summary">
												<span class="text"> 通用后台管理系统（ExtJS 5.1 + Hibernate
													4.3.8 + Spring MVC 4.0.9） </span>
											</span>
										</div>
										...
										<div class="message-item message-unread">
											...
											<span class="sender" title="jeefw"> jeefw <span
												class="light-grey">(4)</span>
											</span> <span class="time">7:15 下午</span> <span class="attachment">
												<i class="ace-icon fa fa-paperclip"></i>
											</span> <span class="summary"> <span
												class="badge badge-pink mail-tag"></span> <span class="text">
													通用后台管理系统（ExtJS 5.1 + Hibernate 4.3.8 + Spring MVC 4.0.9） </span>
											</span>
										</div>
										<!-- /section:pages/inbox.message-list.item -->
										...
										<div class="message-item">
											...
											<span class="sender" title="广告邮件">广告邮件</span> <span
												class="time">3月3日</span> <span class="attachment"> <i
											...
											</span> <span class="text"> 来自QQ邮箱的贺卡 </span>
											</span>
										</div>
										<!-- /section:pages/inbox.message-list.item -->
									</div>
		...
		<form id="id-message-form"
			class="hide form-horizontal message-form col-xs-12" method="POST">
			<!-- #section:pages/inbox.compose -->
			<div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right"
						for="form-field-recipient">收件人:</label>

					<div class="col-sm-6 col-xs-12">
						<div class="input-icon block col-xs-12 no-padding">
							<input type="text" class="col-xs-12" name="recipient"
								id="form-field-recipient" placeholder="" /> <i
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right"
						for="form-field-subject">主题:</label>

					<div class="col-sm-6 col-xs-12">
						<div class="input-icon block col-xs-12 no-padding">
							<input maxlength="100" type="text" class="col-xs-12"
								name="subject" id="form-field-subject" placeholder="主题" /> <i
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right"> <span
						class="inline space-24 hidden-480"></span> 正文:
					</label>
		...
		<div class="hide message-content" id="id-message-content">
			...
			<div class="message-header clearfix">
				<div class="pull-left">
					...
					<i class="ace-icon fa fa-star orange2"></i> &nbsp; <a href="#"
						class="sender">Java框架</a> &nbsp; <i
						class="ace-icon fa fa-clock-o bigger-110 orange middle"></i> <span
						class="time grey">今天, 7:15 pm</span>
				</div>
			...
			<div class="message-body">
				<p>1、系统导入后发布到应用服务器，例如tomcat上即可运行。</p>
				<p>2、导入项目后请将项目编码设置为UTF-8，不是GBK。</p>
			</div>
			...
			<div class="message-attachment clearfix">
				<div class="attachment-title">
					<span class="blue bolder bigger-110">附件</span> &nbsp; <span
					...
					<div class="inline position-relative">
						...
						<ul class="dropdown-menu dropdown-lighter">
							<li><a href="#">转存到中转站</a></li>

							<li><a href="#">转存到微云</a></li>
						</ul>
					</div>
				</div>
				...
				<div class="attachment-images pull-right">
					...
					<div>
						<img width="36" alt="image 4"
							src="${contextPath}/static/assets/images/gallery/thumb-4.jpg" />
						<img width="36" alt="image 3"
							src="${contextPath}/static/assets/images/gallery/thumb-3.jpg" />
						<img width="36" alt="image 2"
							src="${contextPath}/static/assets/images/gallery/thumb-2.jpg" />
						<img width="36" alt="image 1"
							src="${contextPath}/static/assets/images/gallery/thumb-1.jpg" />
					</div>
				</div>
			</div>
