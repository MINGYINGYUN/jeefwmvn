...
<div class="page-header">
	<h1>
		控制台 <small> <i class="ace-icon fa fa-angle-double-right"></i>
			概述&统计
		</small>
	</h1>
</div>
...
<div class="row">
	<div class="col-xs-12">
		...
		<div class="alert alert-block alert-success">
			...
			<strong class="green"> Java企业通用开发平台框架 </strong>
			在淘宝描述的功能全部都有。我们技术团队是淘宝上唯一的不仅提供框架源码，也提供技术支持的开发者。永久免费更新，永久免费无限期技术支持。
		</div>
				...
				<div class="widget-box">
					<div class="widget-header widget-header-flat widget-header-small">
						<h5 class="widget-title">
							<i class="ace-icon fa fa-signal"></i> 访问来源
						</h5>
								...
								<thead class="thin-border-bottom">
									<tr>
										...
										<th class="hidden-480"><i
											class="ace-icon fa fa-caret-right blue"></i>状态</th>
									</tr>
								</thead>
								...
								<tbody>
									<tr>
										...
										<td class="hidden-480"><span
											class="label label-info arrowed-right arrowed-in">在售</span></td>
									</tr>
			...
			<div class="col-sm-7">
				...
				<div class="portlet solid light-grey bordered">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-bullhorn"></i>活动-柱状图
						</div>
						<!-- 
						<div class="tools">
		...
		<div class="row">
							...
							<div class="tab-content padding-8">
								<div id="task-tab" class="tab-pane active">
									<h4 class="smaller lighter green">
										<i class="ace-icon fa fa-list"></i> 可拖拽排序列表
									</h4>

									<!-- #section:pages/dashboard.tasks -->
									<ul id="tasks" class="item-list">
										<li class="item-orange clearfix"><label class="inline">
												<input type="checkbox" class="ace" /> <span class="lbl">客户问答</span>
										</label>
										...
										<li class="item-red clearfix"><label class="inline">
												<input type="checkbox" class="ace" /> <span class="lbl">BUG修复</span>
										...
										<li class="item-default clearfix"><label class="inline">
												<input type="checkbox" class="ace" /> <span class="lbl">增加新特性</span>
											...
											<div
												...
												<ul
													...
													<li><a href="#" class="tooltip-success"
														data-rel="tooltip" title="标记已完成"> <span class="green">
										...
										<li class="item-blue clearfix"><label class="inline">
												<input type="checkbox" class="ace" /> <span class="lbl">更新框架脚本</span>
										</label></li>

										<li class="item-grey clearfix"><label class="inline">
												<input type="checkbox" class="ace" /> <span class="lbl">增加新皮肤</span>
										</label></li>

										<li class="item-green clearfix"><label class="inline">
												<input type="checkbox" class="ace" /> <span class="lbl">升级服务端</span>
										</label></li>

										<li class="item-pink clearfix"><label class="inline">
												<input type="checkbox" class="ace" /> <span class="lbl">清理系统垃圾</span>
										</label></li>
									</ul>
								...
								<div id="member-tab" class="tab-pane">
												...
												<div>
													...
													<div class="inline position-relative">
														...
														<ul
															...
															<li><a href="#" class="tooltip-success"
																data-rel="tooltip" title="批准"> <span class="green">
																		<i class="ace-icon fa fa-check bigger-110"></i>
																</span>
															</a></li>

															<li><a href="#" class="tooltip-warning"
																data-rel="tooltip" title="拒绝"> <span class="orange">
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Alex Doe's avatar"
													src="${contextPath}/static/assets/avatars/avatar5.png" />
											</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Susan's avatar"
													src="${contextPath}/static/assets/avatars/avatar3.png" />
											</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Phil Doe's avatar"
													src="${contextPath}/static/assets/avatars/avatar4.png" />
											</div>
											...
											<div class="body">
												...
												<div>
													<span
														class="label label-info label-sm arrowed-in arrowed-in-right">在线</span>
												</div>
											</div>
										</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Alexa Doe's avatar"
													src="${contextPath}/static/assets/avatars/avatar1.png" />
											</div>
									...
									<div class="center">
										...
										<a href="#" class="btn btn-sm btn-white btn-info"> 查看所有会员
								...
								<div id="comment-tab" class="tab-pane">
									...
									<div class="center">
										...
										&nbsp; <a href="#" class="btn btn-sm btn-white btn-info">
											查看所有评论 &nbsp; <i class="ace-icon fa fa-arrow-right"></i>
										</a>
									</div>
			...
			<div class="col-sm-6">
				<div class="widget-box">
					<div class="widget-header">
						<h4 class="widget-title lighter smaller">
							<i class="ace-icon fa fa-comment blue"></i> 会话
						</h4>
					</div>
						...
						<div class="widget-main no-padding">
							...
							<div class="dialogs">
								<div class="itemdiv dialogdiv">
									...
									<div class="body">
										<div class="time">
											<i class="ace-icon fa fa-clock-o"></i> <span class="green">4秒前</span>
										</div>
								...
								<div class="itemdiv dialogdiv">
									...
									<div class="body">
										<div class="time">
											<i class="ace-icon fa fa-clock-o"></i> <span class="blue">38秒前</span>
										</div>
										...
										<div class="text">Bootstrap
											会自动针对不同的屏幕尺寸调整页面，使其在各个尺寸的屏幕上表现良好。</div>
								...
								<div class="itemdiv dialogdiv">
									...
									<div class="body">
										<div class="time">
											<i class="ace-icon fa fa-clock-o"></i> <span class="orange">2分钟前</span>
										</div>

										<div class="name">
											<a href="#">Bob</a> <span
												class="label label-info arrowed arrowed-in-right">管理员</span>
										</div>
										<div class="text">在移动设备浏览器上，通过设置meta属性为
											user-scalable=no可以禁用其缩放（zooming）功能。</div>
								...
								<div class="itemdiv dialogdiv">
									...
									<div class="body">
										<div class="time">
											<i class="ace-icon fa fa-clock-o"></i> <span class="grey">3分钟前</span>
										</div>
								...
								<div class="itemdiv dialogdiv">
									...
									<div class="body">
										<div class="time">
											<i class="ace-icon fa fa-clock-o"></i> <span class="green">4分钟前</span>
										</div>
							...
							<form>
								<div class="form-actions">
									<div class="input-group">
										<input placeholder="在此输入消息 ..." type="text"
