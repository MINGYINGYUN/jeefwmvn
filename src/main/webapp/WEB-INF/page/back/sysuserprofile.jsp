...
<link rel="stylesheet"
	href="${contextPath}/static/assets/css/bootstrap-editable.css" />

<!-- ajax layout which only needs content area -->
<div class="page-header">
	<h1>
		个人资料页面 <small> <i class="ace-icon fa fa-angle-double-right"></i>
			2种在线编辑风格
		</small>
	</h1>
</div>
	...
	<div class="col-xs-12">
		...
		<div class="clearfix">
			<div class="pull-left alert alert-success no-margin">
				...
				<i class="ace-icon fa fa-umbrella bigger-120 blue"></i> 点击下面的图片或字段编辑
				... &nbsp;&nbsp;
			</div>
				...
				<div class="col-xs-12 col-sm-9">
					...
					<div class="profile-user-info profile-user-info-striped">
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<span class="editable" id="sex"> <c:set var="id"
										value="${sysuser.id}" /> <c:set var="sex"
										value="${sysuser.sex}" /> <c:choose>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<label class="inline"> <input name="sex"
														...
														<c:choose><c:when test="${sysuser.sex == 1}">checked</c:when></c:choose> />
														<span class="lbl middle">男</span>
													</label> &nbsp; &nbsp; &nbsp; <label class="inline"> <input
														name="sex" type="radio" class="ace" value="2"
														<c:choose><c:when test="${sysuser.sex == 2}">checked</c:when></c:choose> />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<span class="input-icon input-icon-right" title="邮箱不可以更改">
												...
												value="${sysuser.email}" readonly /> <i
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<span class="input-icon input-icon-right"> <input
												type="text" id="form-field-phone" value="${sysuser.phone}" />
