		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				...
				<a href="#" class="navbar-brand"> <small> <i
						class="fa fa-leaf"></i>Java企业通用开发平台框架
				</small>
				</a>
				<!-- /section:basics/navbar.layout.brand -->
				...
				<ul class="nav ace-nav">
						...
						<ul
							...
							<li class="dropdown-content">
								<ul class="dropdown-menu dropdown-navbar">
									...
									<li><a href="#">
											<div class="clearfix">
												<span class="pull-left">Bug修复</span> <span
							...
							<li class="dropdown-footer"><a href="#"> 查看更多详细任务 <i
					...
					<li class="purple"><a data-toggle="dropdown"
						...
						<ul
							...
							<li class="dropdown-header"><i
								class="ace-icon fa fa-exclamation-triangle"></i> 8条通知(功能待增加)</li>
							...
							<li class="dropdown-content">
								<ul class="dropdown-menu dropdown-navbar navbar-pink">
									<li><a href="#">
											<div class="clearfix">
												<span class="pull-left"> <i
													class="btn btn-xs no-hover btn-pink fa fa-comment"></i> 新评论
												</span> <span class="pull-right badge badge-info">+12</span>
											</div>
									</a></li>

									<li><a href="#"> <i
											class="btn btn-xs btn-primary fa fa-user"></i> 普通管理员刚登录 ...
									</a></li>
									...
									<li><a href="#">
											<div class="clearfix">
												<span class="pull-left"> <i
													class="btn btn-xs no-hover btn-info fa fa-twitter"></i> 关注
							...
							<li class="dropdown-footer"><a href="#"> 查看更多详细通知 <i
									class="ace-icon fa fa-arrow-right"></i>
							</a></li>
						</ul></li>
					...
					<li class="green"><a data-toggle="dropdown"
						...
						<ul
							class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
							<li class="dropdown-header"><i
								class="ace-icon fa fa-envelope-o"></i> 5条消息(功能待增加)</li>
								...
								<ul class="dropdown-menu dropdown-navbar">
									<li><a href="#" class="clearfix"> <img
											...
											class="msg-body"> <span class="msg-title"> <span
													class="blue">Alex:</span> Bootstrap 编码规范：编写灵活、稳定、高质量的 HTML
													和 CSS 代码的规范 ...
											</span> <span class="msg-time"> <i
													class="ace-icon fa fa-clock-o"></i> <span>15分钟前</span>
											</span>
										</span>
									</a></li>
									...
									<li><a href="#" class="clearfix"> <img
											...
											class="msg-body"> <span class="msg-title"> <span
													class="blue">Susan:</span> 响应式导航（Responsive
									...
									<li><a href="#" class="clearfix"> <img
											...
											class="msg-body"> <span class="msg-title"> <span
													...
													class="ace-icon fa fa-clock-o"></i> <span>下午3:15</span>
											</span>
										</span>
									</a></li>
									...
									<li><a href="#" class="clearfix"> <img
											...
											class="msg-body"> <span class="msg-title"> <span
													class="blue">Kate:</span> HTML5 Boilerplate
													是一套专业的前端模版，用以开发快速、健壮、适应性强的app或网站 ...
											</span> <span class="msg-time"> <i
													class="ace-icon fa fa-clock-o"></i> <span>下午1:33</span>
											</span>
										</span>
									</a></li>
									...
									<li><a href="#" class="clearfix"> <img
											...
											class="msg-body"> <span class="msg-title"> <span
													class="blue">Fred:</span> Unslider — 一个超小的 jQuery
													轮播（slider） 插件。支持主流浏览器、键盘导航、自动调整高度和响应式布局 ...
											</span> <span class="msg-time"> <i
													class="ace-icon fa fa-clock-o"></i> <span>上午10:09</span>
											</span>
										</span>
									</a></li>
								</ul>
							...
							<li class="dropdown-footer"><a href="#"> 查看更多详细消息 <i
									class="ace-icon fa fa-arrow-right"></i>
							</a></li>
						</ul></li>
