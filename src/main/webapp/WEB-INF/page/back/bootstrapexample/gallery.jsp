...
<link rel="stylesheet"
	href="${contextPath}/static/assets/css/colorbox.css" />
	...
	<div class="col-xs-12">
		...
		<div>
			<ul class="ace-thumbnails clearfix">
				...
				<li><a
					href="${contextPath}/static/assets/images/gallery/image-1.jpg"
				...
				<li><a
					href="${contextPath}/static/assets/images/gallery/image-2.jpg"
				...
				<li><a
					href="${contextPath}/static/assets/images/gallery/image-3.jpg"
					data-rel="colorbox"> <img width="150" height="150"
						alt="150x150"
				...
				<!-- /section:pages/gallery.caption -->
				<li><a
					href="${contextPath}/static/assets/images/gallery/image-4.jpg"
					data-rel="colorbox"> <img width="150" height="150"
						alt="150x150"
				...
				<li>
					<div>
						<img width="150" height="150" alt="150x150"
							src="${contextPath}/static/assets/images/gallery/thumb-5.jpg" />
						<div class="text">
							<div class="inner">
								<span>Some Title!</span> <br /> <a
									href="${contextPath}/static/assets/images/gallery/image-5.jpg"
				...
				<li><a
					href="${contextPath}/static/assets/images/gallery/image-6.jpg"
					data-rel="colorbox"> <img width="150" height="150"
						alt="150x150"
						src="${contextPath}/static/assets/images/gallery/thumb-6.jpg" />
				</a>
