	...
	<div class="col-xs-12">
		...
		<div class="well well-sm">
			<h4 class="lighter no-margin-bottom">
				...
				<a href="#custom/content-slider" class="pink btn-display-help">
					Content slider help </a>
			</h4>
		</div>

		<!-- /section:custom/content-slider -->
		<div id="top-menu" class="modal aside" data-fixed="true"
			data-placement="top" data-background="true" data-backdrop="invisible"
			tabindex="-1">
						...
						<div class="row">
							...
							<div class="col-sm-5 text-center line-height-2">
								<a class="btn btn-app btn-Default no-radius" href="#"> <i
									class="ace-icon fa fa-pencil-square-o bigger-230"></i> Default
		...
		<div id="bottom-menu" class="modal aside" data-fixed="true"
			data-placement="bottom" data-background="true"
