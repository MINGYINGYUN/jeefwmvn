					...
					<div class="widget-body">
						<div class="widget-main">
							<ul class="list-unstyled spaced2">
								...
								<li><i class="ace-icon fa fa-times red"></i> Free Domain</li>
							</ul>
					...
					<div class="widget-body">
						<div class="widget-main">
							<ul class="list-unstyled spaced2">
								...
								<li><i class="ace-icon fa fa-check green"></i> Free Domain
								</li>
							</ul>
			...
			<div class="col-xs-6 col-sm-3 pricing-box">
				<div class="widget-box widget-color-blue">
					...
					<div class="widget-body">
						<div class="widget-main">
							<ul class="list-unstyled spaced2">
								<li><i class="ace-icon fa fa-check green"></i> 200 GB Disk
									Space</li>
