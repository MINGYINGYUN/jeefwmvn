...
<link rel="stylesheet"
	href="${contextPath}/static/assets/css/prettify.css" />
							...
							<div class="row">
								<div class="col-xs-12">
									...
									<ul class="list-unstyled spaced2">
										<li><i class="ace-icon fa fa-circle green"></i> Even more
											space</li>
										...
										<li class="muted"><i
											class="ace-icon fa fa-angle-right bigger-110"></i> Unordered
											List Item # 6</li>
